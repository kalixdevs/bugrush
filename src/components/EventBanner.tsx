...
export default async function EventBanner() {
  ...
  return (
    <div className="border-b-2 border-indigo-500 bg-indigo-500/10 px-4 py-2 font-pixel text-[11px] tracking-widest text-indigo-300 flex items-center justify-center gap-3">
